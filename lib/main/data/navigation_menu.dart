...
enum NavigationMenu {
  ...
  portfolio(position: 2, name: 'Portfolio', icon: 'assets/img/portfolio.png'),
  resume(position: 3, name: 'Resume', icon: 'assets/img/resume.png'),
  ...
  contact(position: 4, name: 'Contacts', icon: 'assets/img/contact.png');
